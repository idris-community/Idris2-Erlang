...
-export([
  'case--approx-582'/2,
  'case--exact-561'/2,
  'case--toTokenMap-444'/2,
  'nested--3072-951--in--un--middle'/2,
  'nested--2829-716--in--un--lexStr'/1,
  'nested--2829-717--in--un--control'/0,
  'un--uppers'/0,
  'un--upper'/0,
  'un--toTokenMap'/2,
  'un--symbols'/0,
...
'case--approx-582'(V0, V1) -> case V1 of [] -> ('Idris.Idris2.Text.Lexer.Core':'un--fail'('erased')); [E0 | E1] -> (fun (V2, V3) -> ('Idris.Idris2.Text.Lexer.Core':'un--concatMap'('erased', 'erased', fun (V4) -> ('un--like'(V4)) end, [V2 | V3])) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--exact-561'(V0, V1) -> case V1 of [] -> ('Idris.Idris2.Text.Lexer.Core':'un--fail'('erased')); [E0 | E1] -> (fun (V2, V3) -> ('Idris.Idris2.Text.Lexer.Core':'un--concatMap'('erased', 'erased', fun (V4) -> ('un--is'(V4)) end, [V2 | V3])) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--toTokenMap-444'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> {'Idris.Builtin.MkPair', V2, fun (V4) -> {'Idris.Text.Token.Tok', V3, V4} end} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3072-951--in--un--middle'(V0, V1) -> ('un--manyUntil'('erased', V0, ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', ('un--blockComment'(V1, V0)), ('un--any'()))))).
'nested--2829-716--in--un--lexStr'(V0) -> case V0 of [] -> ('Idris.Idris2.Text.Lexer.Core':'un--fail'('erased')); [E0 | E1] -> (fun (V1, V2) -> ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', ('un--exact'(V1)), ('nested--2829-716--in--un--lexStr'(V2)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2829-717--in--un--control'() -> ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', ('nested--2829-716--in--un--lexStr'([<<"NUL"/utf8>> | [<<"SOH"/utf8>> | [<<"STX"/utf8>> | [<<"ETX"/utf8>> | [<<"EOT"/utf8>> | [<<"ENQ"/utf8>> | [<<"ACK"/utf8>> | [<<"BEL"/utf8>> | [<<"BS"/utf8>> | [<<"HT"/utf8>> | [<<"LF"/utf8>> | [<<"VT"/utf8>> | [<<"FF"/utf8>> | [<<"CR"/utf8>> | [<<"SO"/utf8>> | [<<"SI"/utf8>> | [<<"DLE"/utf8>> | [<<"DC1"/utf8>> | [<<"DC2"/utf8>> | [<<"DC3"/utf8>> | [<<"DC4"/utf8>> | [<<"NAK"/utf8>> | [<<"SYN"/utf8>> | [<<"ETB"/utf8>> | [<<"CAN"/utf8>> | [<<"EM"/utf8>> | [<<"SUB"/utf8>> | [<<"ESC"/utf8>> | [<<"FS"/utf8>> | [<<"GS"/utf8>> | [<<"RS"/utf8>> | [<<"US"/utf8>> | [<<"SP"/utf8>> | [<<"DEL"/utf8>> | []]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]])), ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', {'Idris.Text.Lexer.Core.SeqEat', ('un--is'($x)), fun () -> ('un--hexDigits'()) end}, ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', {'Idris.Text.Lexer.Core.SeqEat', ('un--is'($o)), fun () -> ('un--octDigits'()) end}, ('un--digits'()))))))).
...
'un--exact'(V0) -> ('case--exact-561'(V0, ('Idris.Idris2.Prelude.Types':'un--unpack'(V0)))).
...
'un--charLit'() -> begin (V0 = $\x{27}), {'Idris.Text.Lexer.Core.SeqEat', {'Idris.Text.Lexer.Core.SeqEat', ('un--is'(V0)), fun () -> ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', ('un--escape'($\x{5c}, ('Idris.Idris2.Text.Lexer.Core':'un--<|>'('erased', 'erased', ('nested--2829-717--in--un--control'()), ('un--any'()))))), ('un--isNot'(V0)))) end}, fun () -> ('un--is'(V0)) end} end.
'un--blockComment'(V0, V1) -> {'Idris.Text.Lexer.Core.SeqEat', {'Idris.Text.Lexer.Core.SeqEat', V0, fun () -> ('nested--3072-951--in--un--middle'(V1, V0)) end}, fun () -> V1 end}.
...
'un--approx'(V0) -> ('case--approx-582'(V0, ('Idris.Idris2.Prelude.Types':'un--unpack'(V0)))).
