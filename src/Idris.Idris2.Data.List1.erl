...
-export([
  'case--max-1099'/5,
  'case--min-1071'/5,
  'nested--1738-452--in--un--loop'/8,
  'nested--1718-422--in--un--loop'/5,
...
'case--max-1099'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V3; 1 -> V2; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-1071'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V3; 1 -> V2; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--1738-452--in--un--loop'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of [] -> (V4(V6)); [E0 | E1] -> (fun (V8, V9) -> ((V5(V6))(('nested--1738-452--in--un--loop'('erased', 'erased', V2, V3, V4, V5, V8, V9)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--1718-422--in--un--loop'(V0, V1, V2, V3, V4) -> case V4 of [] -> V3; [E0 | E1] -> (fun (V5, V6) -> ('nested--1718-422--in--un--loop'('erased', V1, V2, V5, V6)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--min_Ord__(List1 $a)'(V0, V1, V2, V3) -> ('case--min-1071'('erased', V1, V3, V2, ('dn--un--<_Ord__(List1 $a)'('erased', V1, V2, V3)))).
'dn--un--max_Ord__(List1 $a)'(V0, V1, V2, V3) -> ('case--max-1099'('erased', V1, V3, V2, ('dn--un-->_Ord__(List1 $a)'('erased', V1, V2, V3)))).
...
'un--last'(V0, V1) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> ('nested--1718-422--in--un--loop'('erased', V2, V3, V2, V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--foldr1\x{27}'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V5, V6) -> ('nested--1738-452--in--un--loop'('erased', 'erased', V5, V6, V3, V2, V5, V6)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
