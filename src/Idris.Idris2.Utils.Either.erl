...
-export([
  'case--partitionEithers-448'/5,
  'case--partitionEithers-410'/5,
  'un--partitionEithers'/3,
  'un--mapError'/5
]).
'case--partitionEithers-448'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', V5, [V2 | V6]} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partitionEithers-410'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V2 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
