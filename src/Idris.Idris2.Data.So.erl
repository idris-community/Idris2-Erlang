...
'un--soOr'(V0, V1, V2) -> ('with--soOr-644'(V1, ('un--choose'(V1)), 'erased', V2)).
...
'un--soAnd'(V0, V1, V2) -> ('with--soAnd-594'(V1, ('un--choose'(V1)), 'erased', V2)).
