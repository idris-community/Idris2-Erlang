...
'rf--min'(V0) -> case V0 of {'Idris.Text.Quantity.Qty', E0, E1} -> (fun (V1, V2) -> V1 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--max'(V0) -> case V0 of {'Idris.Text.Quantity.Qty', E0, E1} -> (fun (V1, V2) -> V2 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
