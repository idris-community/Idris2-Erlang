...
'case--raiseToMaybe-517'(V0, V1, V2, V3) -> case V3 of 0 -> {'Idris.Prelude.Types.Nothing'}; 1 -> {'Idris.Prelude.Types.Just', V2}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
