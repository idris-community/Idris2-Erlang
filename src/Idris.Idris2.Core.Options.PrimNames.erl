...
'rf--fromStringName'(V0) -> case V0 of {'Idris.Core.Options.MkPrimNs', E0, E1, E2} -> (fun (V1, V2, V3) -> V2 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--fromIntegerName'(V0) -> case V0 of {'Idris.Core.Options.MkPrimNs', E0, E1, E2} -> (fun (V1, V2, V3) -> V1 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'rf--fromCharName'(V0) -> case V0 of {'Idris.Core.Options.MkPrimNs', E0, E1, E2} -> (fun (V1, V2, V3) -> V3 end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
