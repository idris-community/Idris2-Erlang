...
'case--mod-459'(V0, V1, V2) -> case V2 of 1 -> (V1 rem V0); _ -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Prelude.Num.case block in mod at Prelude/Num.idr:116:3--118:40"/utf8>>)) end.
'case--div-440'(V0, V1, V2) -> case V2 of 1 -> ((V1 div V0) rem 9223372036854775808); _ -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Prelude.Num.case block in div at Prelude/Num.idr:113:3--115:40"/utf8>>)) end.
'case--abs-408'(V0, V1) -> case V1 of 0 -> ('dn--un--negate_Neg__Int'(V0)); 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mod-337'(V0, V1, V2) -> case V2 of 1 -> (V1 rem V0); _ -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Prelude.Num.case block in mod at Prelude/Num.idr:80:3--82:44"/utf8>>)) end.
'case--div-318'(V0, V1, V2) -> case V2 of 1 -> (V1 div V0); _ -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Prelude.Num.case block in div at Prelude/Num.idr:77:3--79:44"/utf8>>)) end.
