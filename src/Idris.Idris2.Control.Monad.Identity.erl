...
'case--max-715'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V3; 1 -> V2; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-687'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V3; 1 -> V2; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--min_Ord__(Identity $a)'(V0, V1, V2, V3) -> ('case--min-687'('erased', V1, V3, V2, ('dn--un--<_Ord__(Identity $a)'('erased', V1, V2, V3)))).
'dn--un--max_Ord__(Identity $a)'(V0, V1, V2, V3) -> ('case--max-715'('erased', V1, V3, V2, ('dn--un-->_Ord__(Identity $a)'('erased', V1, V2, V3)))).
