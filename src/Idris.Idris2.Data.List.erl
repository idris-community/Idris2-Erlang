...
-export([
  ...
  'case--sortBy-2962'/4,
  'case--mergeBy-2817'/7,
  'case--mapMaybe-2566'/6,
  'case--replaceWhen-1896'/6,
  'case--tails-1849'/2,
  'case--inits-1821'/2,
  'case--case block in partition-1762'/7,
  'case--partition-1741'/5,
  'case--splitAt-1689'/5,
  'case--split-1618'/4,
  'case--case block in span-1544'/5,
  'case--span-1524'/5,
  'case--case block in spanBy-1466'/7,
  'case--spanBy-1416'/6,
  'case--deleteBy-1292'/6,
  'case--nubBy,nubBy\x{27}-1210'/6,
  'case--lookupBy-1089'/8,
  'case--find-1019'/5,
  'case--filter-964'/5,
  'case--dropWhile-910'/5,
  'case--takeWhile-855'/5,
  'case--iterate-802'/4,
  'case--with block in inBounds-695'/6,
  'nested--4825-3099--in--un--spreadHeads'/5,
  'nested--4635-2913--in--un--splitRec'/7,
  'nested--4635-2914--in--un--split'/4,
  'nested--2902-1192--in--un--nubBy\x{27}'/4,
...
'with--inBounds-666'(V0, V1, V2, V3, V4) -> case V3 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.InLater', V5}} end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V6) -> {'Idris.Prelude.Types.No', fun (V7) -> case V7 of {'Idris.Data.List.InLater', E2} -> (fun (V8) -> (V6(V8)) end(E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--sortBy-2962'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> ('un--mergeBy'('erased', V2, ('un--sortBy'('erased', V2, V4)), ('un--sortBy'('erased', V2, V5)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mergeBy-2817'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of 0 -> [V1 | ('un--mergeBy'('erased', V5, V2, [V3 | V4]))]; _ -> [V3 | ('un--mergeBy'('erased', V5, [V1 | V2], V4))] end.
'case--mapMaybe-2566'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> ('un--mapMaybe'('erased', 'erased', V4, V3)) end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V6) -> [V6 | ('un--mapMaybe'('erased', 'erased', V4, V3))] end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--replaceWhen-1896'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> V1; 1 -> V4; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--tails-1849'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> ('un--tails'('erased', V3)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--inits-1821'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor__List'('erased', 'erased', fun (V4) -> [V2 | V4] end, ('un--inits'('erased', V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in partition-1762'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of 0 -> {'Idris.Builtin.MkPair', [V3 | V4], V5}; 1 -> {'Idris.Builtin.MkPair', V4, [V3 | V5]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--partition-1741'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> ('case--case block in partition-1762'('erased', V2, V3, V1, V5, V6, (V3(V1)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--splitAt-1689'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V2 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--split-1618'(V0, V1, V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V4, V5) -> case V5 of [] -> ('Idris.Idris2.Data.List1':'un--singleton'('erased', V4)); [E2 | E3] -> (fun (V6, V7) -> ('Idris.Idris2.Data.List1':'un--cons'('erased', V4, ('un--split'('erased', V2, V7)))) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in span-1544'(V0, V1, V2, V3, V4) -> case V4 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V5, V6) -> {'Idris.Builtin.MkPair', [V3 | V5], V6} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--span-1524'(V0, V1, V2, V3, V4) -> case V4 of 0 -> ('case--case block in span-1544'('erased', V2, V3, V1, ('un--span'('erased', V3, V2)))); 1 -> {'Idris.Builtin.MkPair', [], [V1 | V2]}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--case block in spanBy-1466'(V0, V1, V2, V3, V4, V5, V6) -> case V6 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V7, V8) -> {'Idris.Builtin.MkPair', [V5 | V7], V8} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--spanBy-1416'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> {'Idris.Builtin.MkPair', [], [V2 | V3]} end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V6) -> ('case--case block in spanBy-1466'('erased', 'erased', V3, V4, V2, V6, ('un--spanBy'('erased', 'erased', V4, V3)))) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--deleteBy-1292'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> V3; 1 -> [V2 | ('un--deleteBy'('erased', V4, V1, V3))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--nubBy,nubBy\x{27}-1210'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> ('nested--2902-1192--in--un--nubBy\x{27}'('erased', V4, V3, V2)); 1 -> [V1 | ('nested--2902-1192--in--un--nubBy\x{27}'('erased', [V1 | V4], V3, V2))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--lookupBy-1089'(V0, V1, V2, V3, V4, V5, V6, V7) -> case V7 of 0 -> {'Idris.Prelude.Types.Just', V4}; 1 -> ('un--lookupBy'('erased', 'erased', V6, V2, V5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--find-1019'(V0, V1, V2, V3, V4) -> case V4 of 0 -> {'Idris.Prelude.Types.Just', V1}; 1 -> ('un--find'('erased', V3, V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--filter-964'(V0, V1, V2, V3, V4) -> case V4 of 0 -> [V1 | ('un--filter'('erased', V3, V2))]; 1 -> ('un--filter'('erased', V3, V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--dropWhile-910'(V0, V1, V2, V3, V4) -> case V4 of 0 -> ('un--dropWhile'('erased', V3, V2)); 1 -> [V1 | V2]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--takeWhile-855'(V0, V1, V2, V3, V4) -> case V4 of 0 -> [V1 | ('un--takeWhile'('erased', V3, V2))]; 1 -> []; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--iterate-802'(V0, V1, V2, V3) -> case V3 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> [] end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V4) -> ('un--iterate'('erased', V2, V4)) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--with block in inBounds-695'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Data.List.InLater', E0} -> (fun (V6) -> (V3(V6)) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--4825-3099--in--un--spreadHeads'(V0, V1, V2, V3, V4) -> case V3 of [] -> V4; [E0 | E1] -> (fun (V5, V6) -> case V4 of [] -> [[V5 | []] | ('nested--4825-3099--in--un--spreadHeads'('erased', V1, V2, V6, []))]; [E2 | E3] -> (fun (V7, V8) -> [[V5 | V7] | ('nested--4825-3099--in--un--spreadHeads'('erased', V1, V2, V6, V8))] end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--4635-2913--in--un--splitRec'(V0, V1, V2, V3, V4, V5, V6) -> case V4 of [E0 | E1] -> (fun (V7, V8) -> case V8 of [E2 | E3] -> (fun (V9, V10) -> case V5 of [E4 | E5] -> (fun (V11, V12) -> ('nested--4635-2913--in--un--splitRec'('erased', V1, V2, 'erased', V10, V12, fun (V13) -> (V6([V11 | V13])) end)) end(E4, E5)); _ -> {'Idris.Builtin.MkPair', V5, (V6([]))} end end(E2, E3)); _ -> {'Idris.Builtin.MkPair', V5, (V6([]))} end end(E0, E1)); _ -> {'Idris.Builtin.MkPair', V5, (V6([]))} end.
'nested--4635-2914--in--un--split'(V0, V1, V2, V3) -> ('nested--4635-2913--in--un--splitRec'('erased', V1, V2, 'erased', V3, V3, fun (V4) -> V4 end)).
'nested--2902-1192--in--un--nubBy\x{27}'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> ('case--nubBy,nubBy\x{27}-1210'('erased', V4, V5, V2, V1, ('un--elemBy'('erased', V2, V4, V1)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--transpose'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> ('nested--4825-3099--in--un--spreadHeads'('erased', V2, V3, V2, ('un--transpose'('erased', V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--takeWhile'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> ('case--takeWhile-855'('erased', V3, V4, V1, (V1(V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--splitAt'(V0, V1, V2) -> case V1 of 0 -> {'Idris.Builtin.MkPair', [], V2}; _ -> begin (V3 = (V1 - 1)), case V2 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V4, V5) -> ('case--splitAt-1689'('erased', V3, V4, V5, ('un--splitAt'('erased', V3, V5)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
'un--split'(V0, V1, V2) -> ('case--split-1618'('erased', V2, V1, ('un--break'('erased', V1, V2)))).
'un--spanBy'(V0, V1, V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V4, V5) -> ('case--spanBy-1416'('erased', 'erased', V4, V5, V2, (V2(V4)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--span'(V0, V1, V2) -> case V2 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V3, V4) -> ('case--span-1524'('erased', V3, V4, V1, (V1(V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--sortBy'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> case V4 of [] -> [V3 | []]; _ -> ('case--sortBy-2962'('erased', V2, V1, ('nested--4635-2914--in--un--split'('erased', V2, V1, V2)))) end end(E0, E1)); _ -> ('case--sortBy-2962'('erased', V2, V1, ('nested--4635-2914--in--un--split'('erased', V2, V1, V2)))) end.
...
'un--replaceWhen'(V0, V1, V2, V3) -> ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor__List'('erased', 'erased', fun (V4) -> ('case--replaceWhen-1896'('erased', V2, V3, V1, V4, (V1(V4)))) end, V3)).
...
'un--partition'(V0, V1, V2) -> case V2 of [] -> {'Idris.Builtin.MkPair', [], []}; [E0 | E1] -> (fun (V3, V4) -> ('case--partition-1741'('erased', V3, V4, V1, ('un--partition'('erased', V1, V4)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--nubBy'(V0, V1, V2) -> ('nested--2902-1192--in--un--nubBy\x{27}'('erased', [], V1, V2)).
...
'un--mergeBy'(V0, V1, V2, V3) -> case V2 of [] -> V3; _ -> case V3 of [] -> V2; _ -> case V2 of [E0 | E1] -> (fun (V4, V5) -> case V3 of [E2 | E3] -> (fun (V6, V7) -> ('case--mergeBy-2817'('erased', V4, V5, V6, V7, V1, ((V1(V4))(V6)))) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
...
'un--mapMaybe'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> ('case--mapMaybe-2566'('erased', 'erased', V4, V5, V2, (V2(V4)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--lookupBy'(V0, V1, V2, V3, V4) -> case V4 of [] -> {'Idris.Prelude.Types.Nothing'}; [E0 | E1] -> (fun (V5, V6) -> case V5 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V7, V8) -> ('case--lookupBy-1089'('erased', 'erased', V3, V7, V8, V6, V2, ((V2(V3))(V7)))) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--iterate'(V0, V1, V2) -> [V2 | ('case--iterate-802'('erased', V2, V1, (V1(V2))))].
...
'un--inBounds'(V0, V1, V2) -> case V2 of [] -> {'Idris.Prelude.Types.No', fun (V3) -> ('dn--un--uninhabited_Uninhabited__((InBounds $k) Nil)'('erased', 'erased', 'erased', V3)) end}; _ -> case V1 of 0 -> case V2 of [E2 | E3] -> (fun (V4, V5) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.List.InFirst'}} end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> begin (V6 = (V1 - 1)), case V2 of [E0 | E1] -> (fun (V7, V8) -> ('with--inBounds-666'('erased', V6, V8, ('un--inBounds'('erased', V6, V8)), V7)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
...
'un--find'(V0, V1, V2) -> case V2 of [] -> {'Idris.Prelude.Types.Nothing'}; [E0 | E1] -> (fun (V3, V4) -> ('case--find-1019'('erased', V3, V4, V1, (V1(V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--filter'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> ('case--filter-964'('erased', V3, V4, V1, (V1(V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--dropWhile'(V0, V1, V2) -> case V2 of [] -> []; [E0 | E1] -> (fun (V3, V4) -> ('case--dropWhile-910'('erased', V3, V4, V1, (V1(V3)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--deleteBy'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> ('case--deleteBy-1292'('erased', V2, V4, V5, V1, ((V1(V2))(V4)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
