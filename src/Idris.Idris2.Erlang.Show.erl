...
'case--show-1214'(V0, V1) -> case V1 of E0 -> (fun (V2) -> V2 end((fun (V3) -> ('unicode':'characters_to_binary'(V3)) end(E0)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--show-1176'(V0, V1) -> case V1 of E0 -> (fun (V2) -> V2 end((fun (V3) -> ('unicode':'characters_to_binary'(V3)) end(E0)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--show-1136'(V0, V1) -> case V1 of E0 -> (fun (V2) -> ('Idris.Idris2.Prelude.Types.Strings':'un--++'(<<"#Pid"/utf8>>, V2)) end((fun (V3) -> ('unicode':'characters_to_binary'(V3)) end(E0)))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--show_Show__ErlReference'(V0) -> ('case--show-1176'(V0, ('erlang':'apply'('erlang', 'ref_to_list', [V0 | []])))).
'dn--un--show_Show__ErlPort'(V0) -> ('case--show-1214'(V0, ('erlang':'apply'('erlang', 'port_to_list', [V0 | []])))).
'dn--un--show_Show__ErlPid'(V0) -> ('case--show-1136'(V0, ('erlang':'apply'('erlang', 'pid_to_list', [V0 | []])))).
'dn--un--show_Show__ErlNil'(V0) -> case V0 of [] -> <<"[]"/utf8>>; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--show_Show__ErlCharlist'(V0) -> ('Idris.Idris2.Prelude.Show':'dn--un--show_Show__(List $a)'('erased', {'Idris.Prelude.Show.dn--un--__mkShow', fun (V1) -> ('Idris.Idris2.Prelude.Show':'dn--un--show_Show__Int'(V1)) end, fun (V2) -> fun (V3) -> ('Idris.Idris2.Prelude.Show':'dn--un--showPrec_Show__Int'(V2, V3)) end end}, V0)).
