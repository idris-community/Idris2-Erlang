...
-export([
  ...
  'case--max-7531'/3,
  'case--min-7517'/3,
  'case--replace,go-7372'/6,
  'case--mkNamespacedIdent-7281'/2,
  'nested--3240-7407--in--un--go'/2,
  'nested--3177-7354--in--un--go'/4,
...
'with--decEq-7608'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.No', E0} -> (fun (V3) -> {'Idris.Prelude.Types.No', fun (V4) -> (V3(('un--mkNSInjective'('erased', 'erased', V4)))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', ('Idris.Idris2.Prelude.Basics':'un--cong'('erased', 'erased', 'erased', 'erased', 'erased', V5))} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-7531'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-7517'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--replace,go-7372'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> V1; 1 -> [V3 | ('nested--3177-7354--in--un--go'(V0, V1, V2, V4))]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mkNamespacedIdent-7281'(V0, V1) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> case V3 of [] -> {'Idris.Builtin.MkPair', {'Idris.Prelude.Types.Nothing'}, V2}; _ -> {'Idris.Builtin.MkPair', {'Idris.Prelude.Types.Just', V3}, V2} end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3240-7407--in--un--go'(V0, V1) -> case V1 of [] -> []; [E0 | E1] -> (fun (V2, V3) -> [[V2 | V3] | ('nested--3240-7407--in--un--go'(V0, V3))] end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3177-7354--in--un--go'(V0, V1, V2, V3) -> case V3 of [] -> []; [E0 | E1] -> (fun (V4, V5) -> ('case--replace,go-7372'(V0, V1, V2, V4, V5, ('Idris.Idris2.Prelude.Types':'dn--un--==_Eq__(List $a)'('erased', {'Idris.Prelude.EqOrd.dn--un--__mkEq', fun (V6) -> fun (V7) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__String'(V6, V7)) end end, fun (V8) -> fun (V9) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--/=_Eq__String'(V8, V9)) end end}, V0, [V4 | V5])))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--min_Ord__Namespace'(V0, V1) -> ('case--min-7517'(V1, V0, ('dn--un--<_Ord__Namespace'(V0, V1)))).
'dn--un--max_Ord__Namespace'(V0, V1) -> ('case--max-7531'(V1, V0, ('dn--un-->_Ord__Namespace'(V0, V1)))).
'dn--un--decEq_DecEq__Namespace'(V0, V1) -> ('with--decEq-7608'(V0, V1, ('Idris.Idris2.Decidable.Equality':'dn--un--decEq_DecEq__(List $a)'('erased', fun (V2) -> fun (V3) -> ('Idris.Idris2.Decidable.Equality':'dn--un--decEq_DecEq__String'(V2, V3)) end end, V0, V1)))).
...
'un--replace'(V0, V1, V2) -> ('nested--3177-7354--in--un--go'(V0, V1, V2, V2)).
...
'un--mkNamespacedIdent'(V0) -> ('case--mkNamespacedIdent-7281'(V0, ('Idris.Idris2.Data.List1':'un--reverse'('erased', ('Idris.Idris2.Data.Strings':'un--split'(fun (V1) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__Char'(V1, $.)) end, V0)))))).
...
'un--allParents'(V0) -> ('nested--3240-7407--in--un--go'(V0, V0)).
