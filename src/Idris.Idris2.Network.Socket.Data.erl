...
-export([
  'case--parseIPv4-2755'/2,
  'case--nullPtr-2474'/4,
  'nested--2560-2730--in--un--toInt\x{27}'/2,
  'nested--2560-2731--in--un--toInt'/2,
  'nested--2560-2732--in--un--splitted'/1,
...
'case--parseIPv4-2755'(V0, V1) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> case V3 of [E2 | E3] -> (fun (V4, V5) -> case V5 of [E4 | E5] -> (fun (V6, V7) -> case V7 of [E6 | E7] -> (fun (V8, V9) -> {'Idris.Network.Socket.Data.IPv4Addr', V2, V4, V6, V8} end(E6, E7)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E4, E5)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E2, E3)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end end(E0, E1)); _ -> {'Idris.Network.Socket.Data.InvalidAddress'} end.
'case--nullPtr-2474'(V0, V1, V2, V3) -> case V3 of 0 -> case case case V1 of {'Idris.Prelude.IO.dn--un--__mkHasIO', E14, E15} -> (fun (V4, V5) -> V4 end(E14, E15)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkMonad', E11, E12, E13} -> (fun (V6, V7, V8) -> V6 end(E11, E12, E13)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', E8, E9, E10} -> (fun (V9, V10, V11) -> ((V10('erased'))(1)) end(E8, E9, E10)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end; _ -> case case case V1 of {'Idris.Prelude.IO.dn--un--__mkHasIO', E6, E7} -> (fun (V12, V13) -> V12 end(E6, E7)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkMonad', E3, E4, E5} -> (fun (V14, V15, V16) -> V14 end(E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end of {'Idris.Prelude.Interfaces.dn--un--__mkApplicative', E0, E1, E2} -> (fun (V17, V18, V19) -> ((V18('erased'))(0)) end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end.
'nested--2560-2730--in--un--toInt\x{27}'(V0, V1) -> ('Idris.Idris2.Prelude.Types':'dn--un--cast_Cast__String_Integer'(V1)).
'nested--2560-2731--in--un--toInt'(V0, V1) -> ('nested--2560-2730--in--un--toInt\x{27}'(V0, V1)).
'nested--2560-2732--in--un--splitted'(V0) -> ('Idris.Idris2.Data.List1':'dn--un--map_Functor__List1'('erased', 'erased', fun (V1) -> ('nested--2560-2731--in--un--toInt'(V0, V1)) end, ('Idris.Idris2.Data.Strings':'un--split'(fun (V2) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__Char'(V2, $.)) end, V0)))).
...
'un--parseIPv4'(V0) -> ('case--parseIPv4-2755'(V0, ('nested--2560-2732--in--un--splitted'(V0)))).
