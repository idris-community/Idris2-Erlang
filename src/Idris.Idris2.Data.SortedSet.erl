...
'case--toList-5316'(V0, V1, V2) -> case V2 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V3, V4) -> V3 end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--null'(V0, V1) -> ('Idris.Idris2.Data.SortedMap':'un--null'('erased', 'erased', V1)).
