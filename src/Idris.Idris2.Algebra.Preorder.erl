...
'case--glb-519'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V3; 1 -> V2; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--lub-480'(V0, V1, V2, V3, V4) -> case V4 of 0 -> V2; 1 -> V3; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--lub'(V0, V1, V2, V3) -> ('case--lub-480'('erased', V1, V3, V2, case V1 of {'Idris.Algebra.Preorder.dn--un--__mkPreorder', E0, E1, E2} -> (fun (V4, V5, V6) -> ((V4(V2))(V3)) end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)).
'un--glb'(V0, V1, V2, V3) -> ('case--glb-519'('erased', V1, V3, V2, case V1 of {'Idris.Algebra.Preorder.dn--un--__mkPreorder', E0, E1, E2} -> (fun (V4, V5, V6) -> ((V4(V2))(V3)) end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)).
