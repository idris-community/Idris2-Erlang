...
-export([
  'case--unsafePerformIO-519'/4,
  'case--case block in io_bind-440'/8,
  'case--io_bind-418'/6,
  'case--prim__io_bind-382'/6,
...
'case--unsafePerformIO-519'(V0, V1, V2, V3) -> ('un--unsafeDestroyWorld'('erased', 'erased', V3)).
'case--case block in io_bind-440'(V0, V1, V2, V3, V4, V5, V6, V7) -> (V7(V6)).
'case--io_bind-418'(V0, V1, V2, V3, V4, V5) -> ('case--case block in io_bind-440'('erased', 'erased', 'erased', 'erased', 'erased', V5, 'erased', (V3(V5)))).
'case--prim__io_bind-382'(V0, V1, V2, V3, V4, V5) -> ((V3(V5))('erased')).
'un--unsafePerformIO'(V0, V1) -> ('un--unsafeCreateWorld'('erased', fun (V2) -> ('case--unsafePerformIO-519'('erased', 'erased', 'erased', (V1(V2)))) end)).
...
'un--prim__io_bind'(V0, V1, V2, V3, V4) -> ('case--prim__io_bind-382'('erased', 'erased', 'erased', V3, 'erased', (V2(V4)))).
...
'un--io_bind'(V0, V1, V2, V3, V4) -> ('case--io_bind-418'('erased', 'erased', 'erased', V3, 'erased', (V2(V4)))).
