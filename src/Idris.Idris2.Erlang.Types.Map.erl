...
'case--get-1485'(V0, V1, V2, V3, V4, V5, V6) -> V6.
'case--entries-1393'(V0, V1, V2, V3) -> case V3 of {E0, E1} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', V4, V5} end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--get'(V0, V1, V2, V3, V4, V5) -> ('case--get-1485'('erased', 'erased', 'erased', V3, V5, V4, ('erlang':'apply'('maps', 'get', [V3 | [('Idris.Idris2.Builtin':'un--believe_me'('erased', 'erased', V4)) | []]])))).
