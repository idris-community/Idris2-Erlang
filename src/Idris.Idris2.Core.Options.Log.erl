...
-export([
  'case--keepLog,go,there-7300'/5,
  'case--keepLog,go,here-7267'/6,
  'case--parseLogLevel-7213'/2,
  'case--parseLogLevel-7171'/2,
  'case--show-7089'/2,
  'nested--3473-7261--in--un--there'/5,
  'nested--3473-7260--in--un--here'/5,
  'nested--3468-7255--in--un--go'/5,
...
'case--keepLog,go,there-7300'(V0, V1, V2, V3, V4) -> case V4 of [] -> 1; [E0 | E1] -> (fun (V5, V6) -> ('Idris.Idris2.Data.Maybe':'un--fromMaybe'('erased', fun () -> 1 end, ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad__Maybe'('erased', 'erased', ('Idris.Idris2.Data.These':'un--fromThat'('erased', 'erased', V3)), fun (V7) -> ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad__Maybe'('erased', 'erased', ('Idris.Idris2.Data.StringMap':'un--lookup'('erased', V5, V7)), fun (V8) -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative__Maybe'('erased', ('nested--3468-7255--in--un--go'(V0, V1, V2, V6, V8)))) end)) end)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--keepLog,go,here-7267'(V0, V1, V2, V3, V4, V5) -> case V5 of {'Idris.Prelude.Types.Nothing'} -> (fun () -> 1 end()); {'Idris.Prelude.Types.Just', E0} -> (fun (V6) -> ('Idris.Idris2.Prelude.Types':'dn--un--<=_Ord__Nat'(V0, V6)) end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--parseLogLevel-7213'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad__Maybe'('erased', 'erased', ('Idris.Idris2.Data.Strings':'un--parsePositive'('erased', {'Idris.Prelude.Num.dn--un--__mkNum', fun (V4) -> fun (V5) -> (V4 + V5) end end, fun (V6) -> fun (V7) -> (V6 * V7) end end, fun (V8) -> V8 end}, V3)), fun (V9) -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative__Maybe'('erased', (V2(('Idris.Idris2.Prelude.Types':'dn--un--fromInteger_Num__Nat'(V9)))))) end)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--parseLogLevel-7171'(V0, V1) -> case V1 of {'Idris.Data.List1.:::', E0, E1} -> (fun (V2, V3) -> case V3 of [] -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative__Maybe'('erased', {'Idris.Builtin.MkPair', fun (V4) -> {'Idris.Core.Options.Log.MkLogLevel', [], V4} end, V2})); [E2 | E3] -> (fun (V5, V6) -> case V6 of [] -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative__Maybe'('erased', {'Idris.Builtin.MkPair', ('un--mkLogLevel'(V2)), V5})); _ -> {'Idris.Prelude.Types.Nothing'} end end(E2, E3)); _ -> {'Idris.Prelude.Types.Nothing'} end end(E0, E1)); _ -> {'Idris.Prelude.Types.Nothing'} end.
'case--show-7089'(V0, V1) -> case V1 of [] -> ('Idris.Idris2.Prelude.Show':'dn--un--show_Show__Nat'(V0)); _ -> ('Idris.Idris2.Prelude.Types.Strings':'un--++'(('Idris.Idris2.Data.Strings':'un--fastAppend'(('Idris.Idris2.Data.List':'un--intersperse'('erased', <<"."/utf8>>, V1)))), ('Idris.Idris2.Prelude.Types.Strings':'un--++'(<<":"/utf8>>, ('Idris.Idris2.Prelude.Show':'dn--un--show_Show__Nat'(V0)))))) end.
'nested--3473-7261--in--un--there'(V0, V1, V2, V3, V4) -> case V4 of [] -> 1; [E0 | E1] -> (fun (V5, V6) -> ('Idris.Idris2.Data.Maybe':'un--fromMaybe'('erased', fun () -> 1 end, ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad__Maybe'('erased', 'erased', ('Idris.Idris2.Data.These':'un--fromThat'('erased', 'erased', V3)), fun (V7) -> ('Idris.Idris2.Prelude.Types':'dn--un-->>=_Monad__Maybe'('erased', 'erased', ('Idris.Idris2.Data.StringMap':'un--lookup'('erased', V5, V7)), fun (V8) -> ('Idris.Idris2.Prelude.Types':'dn--un--pure_Applicative__Maybe'('erased', ('nested--3468-7255--in--un--go'(V0, V1, V2, V6, V8)))) end)) end)))) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--3473-7260--in--un--here'(V0, V1, V2, V3, V4) -> ('case--keepLog,go,here-7267'(V0, V1, V2, V3, V4, ('Idris.Idris2.Data.These':'un--fromThis'('erased', 'erased', V3)))).
'nested--3468-7255--in--un--go'(V0, V1, V2, V3, V4) -> ('Idris.Idris2.Prelude.Basics':'un--||'(('nested--3473-7260--in--un--here'(V0, V1, V2, V4, V3)), fun () -> ('nested--3473-7261--in--un--there'(V0, V1, V2, V4, V3)) end)).
...
'un--keepLog'(V0, V1) -> case V0 of {'Idris.Core.Options.Log.MkLogLevel', E0, E1} -> (fun (V2, V3) -> ('nested--3468-7255--in--un--go'(V3, V2, V1, V2, V1)) end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
