...
-export([
  'with--clockTime-790'/2,
  'with--clockTimeReturnType-787'/2,
  'case--with block in clockTime-827'/3,
  'case--compare-567'/6,
  'case--max-508'/4,
  'case--min-487'/4,
...
'with--clockTime-790'(V0, V1) -> case V1 of {'Idris.System.Clock.Mandatory'} -> (fun () -> fun (V2) -> begin (V3 = (('un--fetchOSClock'(V0))(V2))), ('un--fromOSClock'(V0, V3, V2)) end end end()); {'Idris.System.Clock.Optional'} -> (fun () -> fun (V4) -> begin (V5 = (('un--fetchOSClock'(V0))(V4))), begin (V8 = ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor__IO'('erased', 'erased', fun (V6) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__Int'(V6, 1)) end, fun (V7) -> ('un--osClockValid'(V5, V7)) end, V4))), case V8 of 0 -> ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor__IO'('erased', 'erased', fun (V9) -> {'Idris.Prelude.Types.Just', V9} end, fun (V10) -> ('un--fromOSClock'(V0, V5, V10)) end, V4)); 1 -> {'Idris.Prelude.Types.Nothing'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--clockTimeReturnType-787'(V0, V1) -> case V1 of {'Idris.System.Clock.Optional'} -> (fun () -> {'Idris.Prelude.Types.Maybe', {'Idris.System.Clock.Clock', V0}} end()); {'Idris.System.Clock.Mandatory'} -> (fun () -> {'Idris.System.Clock.Clock', V0} end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--with block in clockTime-827'(V0, V1, V2) -> case V2 of 0 -> fun (V3) -> ('Idris.Idris2.Prelude.IO':'dn--un--map_Functor__IO'('erased', 'erased', fun (V4) -> {'Idris.Prelude.Types.Just', V4} end, fun (V5) -> ('un--fromOSClock'(V0, V1, V5)) end, V3)) end; 1 -> fun (V6) -> {'Idris.Prelude.Types.Nothing'} end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--compare-567'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> 0; 2 -> 2; 1 -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord__Integer'(V1, V3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-508'(V0, V1, V2, V3) -> case V3 of 0 -> V2; 1 -> V1; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-487'(V0, V1, V2, V3) -> case V3 of 0 -> V2; 1 -> V1; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'dn--un--min_Ord__(Clock $type)'(V0, V1, V2) -> ('case--min-487'('erased', V2, V1, ('dn--un--<_Ord__(Clock $type)'('erased', V1, V2)))).
'dn--un--max_Ord__(Clock $type)'(V0, V1, V2) -> ('case--max-508'('erased', V2, V1, ('dn--un-->_Ord__(Clock $type)'('erased', V1, V2)))).
'dn--un--compare_Ord__(Clock $type)'(V0, V1, V2) -> case V1 of {'Idris.System.Clock.MkClock', E0, E1, E2} -> (fun (V3, V4, V5) -> case V2 of {'Idris.System.Clock.MkClock', E3, E4, E5} -> (fun (V6, V7, V8) -> ('case--compare-567'(V3, V5, V4, V8, V7, ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord__Integer'(V4, V7)))) end(E3, E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--clockTimeReturnType'(V0) -> ('with--clockTimeReturnType-787'(V0, ('un--isClockMandatory'(V0)))).
...
'un--clockTime'(V0) -> ('with--clockTime-790'(V0, ('un--isClockMandatory'(V0)))).
