...
'case--parenthesise-7176'(V0, V1) -> case V1 of 0 -> fun (V2) -> ('un--parens'('erased', V2)) end; 1 -> fun (V3) -> V3 end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
