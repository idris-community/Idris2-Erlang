...
-export([
  'case--case block in showLitChar-6461'/2,
  'case--showLitChar-6438'/2,
  'case--protectEsc-6185'/4,
  'case--max-5927'/3,
  'case--min-5913'/3,
  'nested--2188-6748--in--un--show\x{27}'/5,
  'nested--1657-6255--in--un--getAt'/3,
  'nested--1657-6254--in--un--asciiTab'/1,
...
'case--case block in showLitChar-6461'(V0, V1) -> case V1 of 0 -> fun (V2) -> ('Idris.Idris2.Prelude.Types':'un--strCons'($\x{5c}, ('un--protectEsc'(fun (V3) -> ('Idris.Idris2.Prelude.Types':'un--isDigit'(V3)) end, ('dn--un--show_Show__Int'(case V0 of E0 when (((erlang:'is_integer'(E0)) andalso (E0 >= 0)) andalso (E0 =< 1114111)) -> E0; _ -> 65533 end)), V2)))) end; 1 -> fun (V4) -> ('Idris.Idris2.Prelude.Types':'un--strCons'(V0, V4)) end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--showLitChar-6438'(V0, V1) -> case V1 of {'Idris.Prelude.Types.Just', E0} -> (fun (V2) -> fun (V3) -> ('Idris.Idris2.Prelude.Types':'un--strCons'($\x{5c}, ('Idris.Idris2.Prelude.Types.Strings':'un--++'(V2, V3)))) end end(E0)); {'Idris.Prelude.Types.Nothing'} -> (fun () -> ('case--case block in showLitChar-6461'(V0, ('Idris.Idris2.Prelude.EqOrd':'dn--un-->_Ord__Char'(V0, $\x{7f})))) end()); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--protectEsc-6185'(V0, V1, V2, V3) -> case V3 of 0 -> <<"\x{5c}&"/utf8>>; 1 -> <<""/utf8>>; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-5927'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-5913'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--2188-6748--in--un--show\x{27}'(V0, V1, V2, V3, V4) -> case V4 of [] -> V3; [E0 | E1] -> (fun (V5, V6) -> case V6 of [] -> ('Idris.Idris2.Prelude.Types.Strings':'un--++'(V3, case V1 of {'Idris.Prelude.Show.dn--un--__mkShow', E4, E5} -> (fun (V7, V8) -> (V7(V5)) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end)); _ -> ('nested--2188-6748--in--un--show\x{27}'('erased', V1, V2, ('Idris.Idris2.Prelude.Types.Strings':'un--++'(V3, ('Idris.Idris2.Prelude.Types.Strings':'un--++'(case V1 of {'Idris.Prelude.Show.dn--un--__mkShow', E2, E3} -> (fun (V9, V10) -> (V9(V5)) end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end, <<", "/utf8>>)))), V6)) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'nested--1657-6255--in--un--getAt'(V0, V1, V2) -> case V1 of 0 -> case V2 of [E2 | E3] -> (fun (V3, V4) -> {'Idris.Prelude.Types.Just', V3} end(E2, E3)); _ -> case V2 of [] -> {'Idris.Prelude.Types.Nothing'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end; _ -> begin (V5 = (V1 - 1)), case V2 of [E0 | E1] -> (fun (V6, V7) -> ('nested--1657-6255--in--un--getAt'(V0, V5, V7)) end(E0, E1)); _ -> case V2 of [] -> {'Idris.Prelude.Types.Nothing'}; _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end end.
'nested--1657-6254--in--un--asciiTab'(V0) -> [<<"NUL"/utf8>> | [<<"SOH"/utf8>> | [<<"STX"/utf8>> | [<<"ETX"/utf8>> | [<<"EOT"/utf8>> | [<<"ENQ"/utf8>> | [<<"ACK"/utf8>> | [<<"BEL"/utf8>> | [<<"BS"/utf8>> | [<<"HT"/utf8>> | [<<"LF"/utf8>> | [<<"VT"/utf8>> | [<<"FF"/utf8>> | [<<"CR"/utf8>> | [<<"SO"/utf8>> | [<<"SI"/utf8>> | [<<"DLE"/utf8>> | [<<"DC1"/utf8>> | [<<"DC2"/utf8>> | [<<"DC3"/utf8>> | [<<"DC4"/utf8>> | [<<"NAK"/utf8>> | [<<"SYN"/utf8>> | [<<"ETB"/utf8>> | [<<"CAN"/utf8>> | [<<"EM"/utf8>> | [<<"SUB"/utf8>> | [<<"ESC"/utf8>> | [<<"FS"/utf8>> | [<<"GS"/utf8>> | [<<"RS"/utf8>> | [<<"US"/utf8>> | []]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]].
...
'dn--un--show_Show__(List $a)'(V0, V1, V2) -> ('Idris.Idris2.Prelude.Types.Strings':'un--++'(<<"["/utf8>>, ('Idris.Idris2.Prelude.Types.Strings':'un--++'(('nested--2188-6748--in--un--show\x{27}'('erased', V1, V2, <<""/utf8>>, V2)), <<"]"/utf8>>)))).
...
'dn--un--min_Ord__Prec'(V0, V1) -> ('case--min-5913'(V1, V0, ('dn--un--<_Ord__Prec'(V0, V1)))).
'dn--un--max_Ord__Prec'(V0, V1) -> ('case--max-5927'(V1, V0, ('dn--un-->_Ord__Prec'(V0, V1)))).
...
'un--protectEsc'(V0, V1, V2) -> ('Idris.Idris2.Prelude.Types.Strings':'un--++'(V1, ('Idris.Idris2.Prelude.Types.Strings':'un--++'(('case--protectEsc-6185'(V2, V1, V0, ('un--firstCharIs'(V0, V2)))), V2)))).
