...
'nested--2485-3808--in--un--acc'(V0, V1, V2, V3, V4, V5) -> case V3 of 0 -> ('erlang':'throw'("Nat case not covered")); _ -> begin (V6 = (V3 - 1)), case V5 of {'Idris.Data.Nat.LTESucc', E0} -> (fun (V7) -> fun (V8) -> fun (V9) -> ('nested--2485-3808--in--un--acc'('erased', V1, V2, V6, V8, ('Idris.Idris2.Data.Nat':'un--lteTransitive'('erased', 'erased', 'erased', V9, V7)))) end end end(E0)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end end.
...
'un--sizeAccessible'(V0, V1, V2, V3, V4) -> ('nested--2485-3808--in--un--acc'('erased', V1, V2, (V1(V2)), V3, V4)).
