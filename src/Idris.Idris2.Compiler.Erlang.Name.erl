...
-export([
  'case--constructorName-7899'/3,
  'case--moduleNameFunctionName-7869'/3,
  'case--isNameInCurrentModule-7846'/3,
  'case--currentModuleName-7833'/2,
  'case--moduleNameForNS-7814'/3,
  'case--max-7671'/3,
  'case--min-7657'/3,
  'case--compare-7530'/5,
...
'case--constructorName-7899'(V0, V1, V2) -> case V2 of {'Idris.Core.Name.UN', E0} -> (fun (V3) -> V3 end(E0)); _ -> ('un--genName'(V2)) end.
'case--moduleNameFunctionName-7869'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> {'Idris.Builtin.MkPair', V3, ('un--genName'(V0))} end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> {'Idris.Builtin.MkPair', ('un--moduleNameForName'(V1, V0)), ('un--genName'(('Idris.Idris2.Core.Name':'un--dropNS'(V0))))} end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--isNameInCurrentModule-7846'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> 0 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__String'(('un--moduleNameForName'(V1, V0)), ('un--currentModuleName'(V1)))) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--currentModuleName-7833'(V0, V1) -> case V1 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V2) -> V2 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V3, V4) -> ('un--moduleNameForNS'(V0, V4)) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--moduleNameForNS-7814'(V0, V1, V2) -> case V2 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V3) -> V3 end(E0)); {'Idris.Compiler.Erlang.Name.Split', E1, E2} -> (fun (V4, V5) -> ('Idris.Idris2.Core.Name.Namespace':'dn--un--show_Show__Namespace'(('Idris.Idris2.Core.Name.Namespace':'un--<.>'(('Idris.Idris2.Core.Name.Namespace':'un--mkNamespace'(V4)), V0)))) end(E1, E2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--max-7671'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--min-7657'(V0, V1, V2) -> case V2 of 0 -> V1; 1 -> V0; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--compare-7530'(V0, V1, V2, V3, V4) -> case V4 of 0 -> 0; 2 -> 2; 1 -> ('Idris.Idris2.Core.Name.Namespace':'dn--un--compare_Ord__Namespace'(V0, V2)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'dn--un--min_Ord__NamespaceInfo'(V0, V1) -> ('case--min-7657'(V1, V0, ('dn--un--<_Ord__NamespaceInfo'(V0, V1)))).
'dn--un--max_Ord__NamespaceInfo'(V0, V1) -> ('case--max-7671'(V1, V0, ('dn--un-->_Ord__NamespaceInfo'(V0, V1)))).
'dn--un--compare_Ord__OutputBundle'(V0, V1) -> case V0 of {'Idris.Compiler.Erlang.Name.Concat', E0} -> (fun (V2) -> case V1 of {'Idris.Compiler.Erlang.Name.Concat', E1} -> (fun (V3) -> ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord__String'(V2, V3)) end(E1)); {'Idris.Compiler.Erlang.Name.Split', E2, E3} -> (fun (V4, V5) -> 0 end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0)); {'Idris.Compiler.Erlang.Name.Split', E4, E5} -> (fun (V6, V7) -> case V1 of {'Idris.Compiler.Erlang.Name.Split', E6, E7} -> (fun (V8, V9) -> ('case--compare-7530'(V7, V6, V9, V8, ('Idris.Idris2.Prelude.EqOrd':'dn--un--compare_Ord__String'(V6, V8)))) end(E6, E7)); {'Idris.Compiler.Erlang.Name.Concat', E8} -> (fun (V10) -> 2 end(E8)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--moduleNameFunctionName'(V0, V1) -> ('case--moduleNameFunctionName-7869'(V1, V0, V0)).
'un--moduleNameForName'(V0, V1) -> ('un--moduleNameForNS'(V0, ('un--getNamespace'(V1)))).
'un--moduleNameForNS'(V0, V1) -> ('case--moduleNameForNS-7814'(V1, V0, V0)).
'un--isNameInCurrentModule'(V0, V1) -> ('case--isNameInCurrentModule-7846'(V1, V0, V0)).
