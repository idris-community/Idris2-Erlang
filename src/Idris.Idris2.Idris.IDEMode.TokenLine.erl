...
-export([
  'case--case block in tokens-481'/6,
  'case--tokens-449'/2,
  'un--tokens'/1,
  'un--toString'/1,
  'un--srcTokens'/0,
...
'case--case block in tokens-481'(V0, V1, V2, V3, V4, V5) -> case V5 of 0 -> []; 1 -> [{'Idris.Idris.IDEMode.TokenLine.Other', V4} | []]; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--tokens-449'(V0, V1) -> case V1 of {'Idris.Builtin.MkPair', E0, E1} -> (fun (V2, V3) -> case V3 of {'Idris.Builtin.MkPair', E2, E3} -> (fun (V4, V5) -> case V5 of {'Idris.Builtin.MkPair', E4, E5} -> (fun (V6, V7) -> ('Idris.Idris2.Prelude.Types.List':'un--++'('erased', ('Idris.Idris2.Prelude.Types':'dn--un--map_Functor__List'('erased', 'erased', fun (V8) -> case V8 of {'Idris.Text.Bounded.MkBounded', E6, E7, E8, E9, E10, E11} -> (fun (V9, V10, V11, V12, V13, V14) -> V9 end(E6, E7, E8, E9, E10, E11)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end, V2)), ('case--case block in tokens-481'(V0, V2, V4, V6, V7, ('Idris.Idris2.Prelude.EqOrd':'dn--un--==_Eq__String'(V7, <<""/utf8>>)))))) end(E4, E5)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E2, E3)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'un--tokens'(V0) -> ('case--tokens-449'(V0, ('Idris.Idris2.Text.Lexer.Core':'un--lex'('erased', ('un--srcTokens'()), V0)))).
