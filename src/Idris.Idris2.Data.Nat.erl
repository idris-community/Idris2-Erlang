...
-export([
  'with--cmp-888'/3,
  'case--divmod\x{27}-784'/4,
  'case--divCeilNZ-744'/4,
  'case--div\x{27}-703'/4,
  'case--mod\x{27}-662'/4,
  'case--isLTE-458'/3,
...
'with--cmp-888'(V0, V1, V2) -> case V2 of {'Idris.Data.Nat.CmpLT', E0} -> (fun (V3) -> {'Idris.Data.Nat.CmpLT', V3} end(E0)); {'Idris.Data.Nat.CmpEQ'} -> (fun () -> {'Idris.Data.Nat.CmpEQ'} end()); {'Idris.Data.Nat.CmpGT', E1} -> (fun (V4) -> {'Idris.Data.Nat.CmpGT', V4} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--divmod\x{27}-784'(V0, V1, V2, V3) -> case V3 of 0 -> {'Idris.Builtin.MkPair', 0, V2}; 1 -> begin (V4 = ('un--divmod\x{27}'(V0, ('Idris.Idris2.Prelude.Types':'un--minus'(V2, (1 + V1))), V1))), {'Idris.Builtin.MkPair', (1 + ('Idris.Idris2.Builtin':'un--fst'('erased', 'erased', V4))), ('Idris.Idris2.Builtin':'un--snd'('erased', 'erased', V4))} end; _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--divCeilNZ-744'(V0, V1, V2, V3) -> case V3 of 0 -> ('un--divNatNZ'(V2, V0, V1)); _ -> (1 + ('un--divNatNZ'(V2, V0, V1))) end.
'case--div\x{27}-703'(V0, V1, V2, V3) -> case V3 of 0 -> 0; 1 -> (1 + ('un--div\x{27}'(V0, ('Idris.Idris2.Prelude.Types':'un--minus'(V2, (1 + V1))), V1))); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--mod\x{27}-662'(V0, V1, V2, V3) -> case V3 of 0 -> V2; 1 -> ('un--mod\x{27}'(V0, ('Idris.Idris2.Prelude.Types':'un--minus'(V2, (1 + V1))), V1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'case--isLTE-458'(V0, V1, V2) -> case V2 of {'Idris.Prelude.Types.No', E0} -> (fun (V3) -> {'Idris.Prelude.Types.No', fun (V4) -> (V3(('un--fromLteSucc'('erased', 'erased', V4)))) end} end(E0)); {'Idris.Prelude.Types.Yes', E1} -> (fun (V5) -> {'Idris.Prelude.Types.Yes', {'Idris.Data.Nat.LTESucc', V5}} end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
...
'un--zeroMultEitherZero'(V0, V1, V2) -> case V0 of 0 -> {'Idris.Prelude.Types.Left', {'Idris.Builtin.Refl'}}; _ -> begin (V3 = (V0 - 1)), {'Idris.Prelude.Types.Right', ('un--zeroPlusLeftZero'(V1, ('Idris.Idris2.Prelude.Types':'dn--un--*_Num__Nat'(V3, V1)), {'Idris.Builtin.Refl'}))} end end.
...
'un--modNat'(V0, V1) -> case V1 of 0 -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Data.Nat.modNat at Data/Nat.idr:196:1--196:56"/utf8>>)); _ -> begin (V2 = (V1 - 1)), ('un--modNatNZ'(V0, (1 + V2), fun (V3) -> ('un--SIsNotZ'('erased', V3)) end)) end end.
'un--mod\x{27}'(V0, V1, V2) -> case V0 of 0 -> V1; _ -> begin (V3 = (V0 - 1)), ('case--mod\x{27}-662'(V3, V2, V1, ('un--lte'(V1, V2)))) end end.
...
'un--isLTE'(V0, V1) -> case V0 of 0 -> {'Idris.Prelude.Types.Yes', {'Idris.Data.Nat.LTEZero'}}; _ -> begin (V2 = (V0 - 1)), case V1 of 0 -> {'Idris.Prelude.Types.No', fun (V3) -> ('un--succNotLTEzero'('erased', V3)) end}; _ -> begin (V4 = (V1 - 1)), ('case--isLTE-458'(V2, V4, ('un--isLTE'(V2, V4)))) end end end end.
...
'un--divmodNatNZ'(V0, V1, V2) -> case V1 of 0 -> ('erlang':'throw'("Error: Executed \x{27}void\x{27}")); _ -> begin (V3 = (V1 - 1)), ('un--divmod\x{27}'(V0, V0, V3)) end end.
'un--divmod\x{27}'(V0, V1, V2) -> case V0 of 0 -> {'Idris.Builtin.MkPair', 0, V1}; _ -> begin (V3 = (V0 - 1)), ('case--divmod\x{27}-784'(V3, V2, V1, ('un--lte'(V1, V2)))) end end.
'un--divNatNZ'(V0, V1, V2) -> case V1 of 0 -> ('erlang':'throw'("Error: Executed \x{27}void\x{27}")); _ -> begin (V3 = (V1 - 1)), ('un--div\x{27}'(V0, V0, V3)) end end.
'un--divNat'(V0, V1) -> case V1 of 0 -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Data.Nat.divNat at Data/Nat.idr:218:1--218:56"/utf8>>)); _ -> begin (V2 = (V1 - 1)), ('un--divNatNZ'(V0, (1 + V2), fun (V3) -> ('un--SIsNotZ'('erased', V3)) end)) end end.
'un--divCeilNZ'(V0, V1, V2) -> ('case--divCeilNZ-744'(V1, V2, V0, ('un--modNatNZ'(V0, V1, V2)))).
'un--divCeil'(V0, V1) -> case V1 of 0 -> ('Idris.Idris2.Builtin':'un--idris_crash'('erased', <<"Unhandled input for Data.Nat.divCeil at Data/Nat.idr:228:1--228:44"/utf8>>)); _ -> begin (V2 = (V1 - 1)), ('un--divCeilNZ'(V0, (1 + V2), fun (V3) -> ('un--SIsNotZ'('erased', V3)) end)) end end.
'un--div\x{27}'(V0, V1, V2) -> case V0 of 0 -> 0; _ -> begin (V3 = (V0 - 1)), ('case--div\x{27}-703'(V3, V2, V1, ('un--lte'(V1, V2)))) end end.
'un--cmp'(V0, V1) -> case V0 of 0 -> case V1 of 0 -> {'Idris.Data.Nat.CmpEQ'}; _ -> begin (V2 = (V1 - 1)), {'Idris.Data.Nat.CmpLT', V2} end end; _ -> begin (V3 = (V0 - 1)), case V1 of 0 -> {'Idris.Data.Nat.CmpGT', V3}; _ -> begin (V4 = (V1 - 1)), ('with--cmp-888'(V3, V4, ('un--cmp'(V3, V4)))) end end end end.
