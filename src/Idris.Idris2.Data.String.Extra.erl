...
-export([
  'with--index-2471'/3,
  'with--with block in takeLast-2439'/4,
  'with--takeLast-2437'/3,
  'un--takeLast'/2,
  'un--take'/2,
  'un--strSnoc'/2,
  'un--shrink'/2,
...
'with--index-2471'(V0, V1, V2) -> case V1 of [] -> {'Idris.Prelude.Types.Nothing'}; [E0 | E1] -> (fun (V3, V4) -> case V2 of 0 -> {'Idris.Prelude.Types.Just', V3}; _ -> begin (V5 = (V2 - 1)), ('with--index-2471'(V0, V4, V5)) end end end(E0, E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--with block in takeLast-2439'(V0, V1, V2, V3) -> case V2 of {'Idris.Prelude.Types.Yes', E0} -> (fun (V4) -> ('Idris.Idris2.Prelude.Types':'un--substr'(('Idris.Idris2.Prelude.Types':'un--minus'(V1, V0)), V1, V3)) end(E0)); {'Idris.Prelude.Types.No', E1} -> (fun (V5) -> V3 end(E1)); _ -> ('erlang':'throw'("Error: Unreachable branch")) end.
'with--takeLast-2437'(V0, V1, V2) -> ('with--with block in takeLast-2439'(V2, V1, ('Idris.Idris2.Data.Nat':'un--isLTE'(V2, V1)), V0)).
'un--takeLast'(V0, V1) -> ('with--takeLast-2437'(V1, ('Idris.Idris2.Prelude.Types.Strings':'un--length'(V1)), V0)).
...
'un--index'(V0, V1) -> ('with--index-2471'(V1, ('Idris.Idris2.Prelude.Types':'un--unpack'(V1)), V0)).
